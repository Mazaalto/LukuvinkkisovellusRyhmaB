...
public class UI {
    ...
    private void printCommands() throws Exception {
        ...
        while (true) {
            System.out.println("1 (lisää lukuvinkki), 2 (listaa lukuvinkit), 3 (poista lukuvinkki), 4 (kerro vinkkien määrä), 5 (poista kaikki lukuvinkit), 6 (merkkaa lukuvinkki luetuksi), tyhjä lopettaa");
            ...
            if (komento.equals("") || komento.equals(" ")) {
                ...
                if (lukuvinkit.isEmpty()) {
                    System.out.println("Ei vielä yhtään lukuvinkkiä, jonka voisi merkata luetuksi");
                } else {
                    System.out.println("Lukuvinkit tällä hetkellä:");

                    lukuvinkit.stream().forEach(lv -> System.out.println(lv));
                    while (true) {
                        System.out.println("Anna otsikko, jonka haluat merkata luetuksi:");
                        String otsikko = reader.nextLine();
